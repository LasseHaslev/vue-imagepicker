...
exports.default = {
    ...
    methods: {
        ...
        itemError: function itemError(data) {
...
module.exports = {
    ...
    methods: {
        ...
        itemNotDeleted: function itemNotDeleted(reason) {
...
module.exports = {
    ...
    methods: {
        loadModels: function loadModels(url) {
    ...
    events: {
        'ModelCreated': function ModelCreated(model) {
            this.addModel(model);
        },
        'ModelDeleted': function ModelDeleted(model) {
...
exports.remove = exports.update = exports.create = exports.container = undefined;

var _CreateModel = require('./Mixins/CreateModel');

var _CreateModel2 = _interopRequireDefault(_CreateModel);

var _UpdateModel = require('./Mixins/UpdateModel');

var _UpdateModel2 = _interopRequireDefault(_UpdateModel);

var _DeleteModel = require('./Mixins/DeleteModel');

var _DeleteModel2 = _interopRequireDefault(_DeleteModel);

var _ModelContainer = require('./Mixins/ModelContainer');

var _ModelContainer2 = _interopRequireDefault(_ModelContainer);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.container = _ModelContainer2.default;
exports.create = _CreateModel2.default;
exports.update = _UpdateModel2.default;
exports.remove = _DeleteModel2.default;
// export object CreateModelMixin;
// export UpdateModelMixin;
// export DeleteModelMixin;

},{"./Mixins/CreateModel":1,"./Mixins/DeleteModel":2,"./Mixins/ModelContainer":4,"./Mixins/UpdateModel":5}],7:[function(require,module,exports){
...
var __vueify_style__ = __vueify_insert__.insert("/* Modal width */\n/* Modal style */\n/* Modal backdrop */\n/* Modal close button */\n/* line 22, stdin */\n.Modal, .Modal__backdrop, .Modal__scrollable {\n  position: fixed;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  z-index: 99998; }\n\n/* line 31, stdin */\n.Modal__CloseButton {\n  -webkit-transition: all .8s;\n  transition: all .8s;\n  cursor: pointer;\n  position: absolute;\n  top: -10px;\n  right: -10px;\n  width: 25px;\n  height: 25px;\n  background-color: white;\n  border-radius: 50%;\n  box-shadow: 0 0 8px #000; }\n  /* line 47, stdin */\n  .Modal__CloseButton:hover {\n    box-shadow: 0 3px 12px #000;\n    -webkit-transform: scale(1.05);\n            transform: scale(1.05); }\n  /* line 52, stdin */\n  .Modal__CloseButton__icon {\n    /* Vertical alicn */\n    position: relative;\n    top: 50%;\n    -webkit-transform: translateY(-50%);\n            transform: translateY(-50%);\n    text-align: center; }\n    /* line 59, stdin */\n    .Modal__CloseButton__icon:before {\n      content: \"X\"; }\n\n/* line 64, stdin */\n.Modal__content {\n  background-color: white;\n  border-radius: 10px;\n  padding: 16px; }\n\n/* line 69, stdin */\n.Modal__scrollable {\n  overflow: auto; }\n\n/* line 72, stdin */\n.Modal__backdrop {\n  z-index: -1000;\n  background-color: black;\n  opacity: 0.725; }\n\n/* line 77, stdin */\n.Modal__container {\n  position: relative;\n  width: 90%;\n  max-width: 730px;\n  margin: 3% auto; }\n")
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  module.hot.dispose(function () {
    __vueify_insert__.cache["/* Modal width */\n/* Modal style */\n/* Modal backdrop */\n/* Modal close button */\n/* line 22, stdin */\n.Modal, .Modal__backdrop, .Modal__scrollable {\n  position: fixed;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  z-index: 99998; }\n\n/* line 31, stdin */\n.Modal__CloseButton {\n  -webkit-transition: all .8s;\n  transition: all .8s;\n  cursor: pointer;\n  position: absolute;\n  top: -10px;\n  right: -10px;\n  width: 25px;\n  height: 25px;\n  background-color: white;\n  border-radius: 50%;\n  box-shadow: 0 0 8px #000; }\n  /* line 47, stdin */\n  .Modal__CloseButton:hover {\n    box-shadow: 0 3px 12px #000;\n    -webkit-transform: scale(1.05);\n            transform: scale(1.05); }\n  /* line 52, stdin */\n  .Modal__CloseButton__icon {\n    /* Vertical alicn */\n    position: relative;\n    top: 50%;\n    -webkit-transform: translateY(-50%);\n            transform: translateY(-50%);\n    text-align: center; }\n    /* line 59, stdin */\n    .Modal__CloseButton__icon:before {\n      content: \"X\"; }\n\n/* line 64, stdin */\n.Modal__content {\n  background-color: white;\n  border-radius: 10px;\n  padding: 16px; }\n\n/* line 69, stdin */\n.Modal__scrollable {\n  overflow: auto; }\n\n/* line 72, stdin */\n.Modal__backdrop {\n  z-index: -1000;\n  background-color: black;\n  opacity: 0.725; }\n\n/* line 77, stdin */\n.Modal__container {\n  position: relative;\n  width: 90%;\n  max-width: 730px;\n  margin: 3% auto; }\n"] = false
    document.head.removeChild(__vueify_style__)
  })
  if (!module.hot.data) {
    hotAPI.createRecord("_v-73e10a2e", module.exports)
  } else {
    hotAPI.update("_v-73e10a2e", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":11,"vue-hot-reload-api":8,"vueify/lib/insert-css":12}],10:[function(require,module,exports){
/*!
 * vue-resource v0.9.3
...
var _restfulVue = require('@lassehaslev/restful-vue');

var _vueModalBrowserify = require('vue-modal-browserify');

var _vueModalBrowserify2 = _interopRequireDefault(_vueModalBrowserify);

var _PickerItem = require('./PickerItem.vue');
...
exports.default = {
    ...
    events: {
        ...
        'ImageDeselected': function ImageDeselected(image) {
        ...
        'ImageConfirmed': function ImageConfirmed() {
            this.confirm();
        }
    },
    ...
    components: {
        Modal: _vueModalBrowserify2.default,
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-54bf891a", module.exports)
  } else {
    hotAPI.update("_v-54bf891a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./PickerItem.vue":14,"@lassehaslev/restful-vue":6,"vue":11,"vue-hot-reload-api":8,"vue-modal-browserify":9,"vueify/lib/insert-css":12}],14:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("/* line 8, stdin */\n.PickerItem {\n  -webkit-transition: all 5s;\n  transition: all 5s;\n  -webkit-transition: width .4s;\n  transition: width .4s;\n  width: calc(100% * (1/1) - 16px - 1px);\n  margin-left: 8px;\n  margin-right: 8px;\n  background-color: #EEE;\n  margin-bottom: 16px; }\n  @media (min-width: 350px) {\n    /* line 8, stdin */\n    .PickerItem {\n      width: calc(100% * (1/2) - 16px - 1px); } }\n  @media (min-width: 580px) {\n    /* line 8, stdin */\n    .PickerItem {\n      width: calc(100% * (1/3) - 16px - 1px); } }\n  @media (min-width: 780px) {\n    /* line 8, stdin */\n    .PickerItem {\n      width: calc(100% * (1/4) - 16px - 1px); } }\n  /* line 30, stdin */\n  .PickerItem--selected {\n    position: relative; }\n    /* line 32, stdin */\n    .PickerItem--selected:before {\n      position: absolute;\n      display: block;\n      content: '';\n      top: 0;\n      right: 0;\n      bottom: 0;\n      left: 0;\n      border: 8px solid #DDF;\n      background-color: rgba(0, 0, 0, 0.65); }\n    /* line 45, stdin */\n    .PickerItem--selected:after {\n      font-size: 1.5em;\n      position: absolute;\n      display: block;\n      content: \"v\";\n      color: white;\n      bottom: 16px;\n      right: 16px; }\n  /* line 57, stdin */\n  .PickerItem__image {\n    padding-top: 100%;\n    background-repeat: no-repeat;\n    background-position: center;\n    background-size: contain; }\n")
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-e15eedf2", module.exports)
  } else {
    hotAPI.update("_v-e15eedf2", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":11,"vue-hot-reload-api":8,"vueify/lib/insert-css":12}],15:[function(require,module,exports){
'use strict';
...
var _ImagePicker = require('./ImagePicker/ImagePicker.vue');
...
new _vue2.default({
    ...
    events: {
        'ImageSelected': function ImageSelected(selected) {
            console.log(selected);
        }
    },

    components: { ImagePicker: _ImagePicker2.default }
});

},{"./ImagePicker/ImagePicker.vue":13,"vue":11,"vue-resource":10}]},{},[15]);
